...
public class ScanedImage {
	...
	public static void processImg(BufferedImage ipimage, float scaleFactor, float offset)
		...
		ImageIO.write(fopimage, "jpg", new File("C:\\Users\\sachin.boob\\Downloads\\output.png"));

		// Instantiating the Tesseract class
		// which is used to perform OCR
		Tesseract it = new Tesseract();

		it.setDatapath("C:\\Users\\sachin.boob\\Downloads\\Tess4J-3.4.8-src\\Tess4J\\tessdata");
	...
	public static void main(String args[]) throws Exception {
		File f = new File("C:\\Users\\sachin.boob\\Downloads\\For-complex-OCR.JPG");
